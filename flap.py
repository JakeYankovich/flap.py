...
while run:
    ...
    if p1rect.collidepoint(430, (y+50)):
        win.blit(textsurface,(120, (pipeheight-150)))              #detect hit bottom pipe
        lose = True
    elif p2rect.collidepoint(430, (y+50)):
        win.blit(textsurface,(120, (pipeheight2-150)))          
        lose = True
    elif p3rect.collidepoint(430, (y+50)):
        win.blit(textsurface,(120, (pipeheight3-150)))          
        lose = True
    
    if tp1rect.collidepoint(430, (y+15)):
        win.blit(textsurface,(120, (pipeheight-150)))              #detect hit top pipe
        lose = True
